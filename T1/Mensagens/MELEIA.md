...
O sistema é composto por um servidor central e dois tipos de clientes distintos: um para o envio de mensagens e outro exclusivo para a visualização do histórico em tempo real.
